    ...
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void AddButton_Click(object sender, EventArgs e)
        {
            ...
            if (assetCheck == true)
            {
                ...
                /*
                int electionCurrent = electionLog[foundIndex];
                int subterfugeCurrent = subterfugeLog[foundIndex];
                electionCurrent += electionAddition;
                subterfugeCurrent += subterfugeAddition;

                electionLog[foundIndex] = electionCurrent;
                subterfugeLog[foundIndex] = subterfugeCurrent;
                */
